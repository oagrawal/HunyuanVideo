#!/bin/bash
# K=15, retention_ratio=0.1 runs — GPU 2, prompts 18-27
# 3 fixed thresholds: low (0.06), medium (0.24), max (0.80)
cd /nfs/oagrawal/HunyuanVideo
CUDA_VISIBLE_DEVICES=2 python3 magcache_eval/batch_generate.py \
  ...
  2>&1 | tee magcache_eval/logs/gpu2_k15.log
